...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/catatan/save" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>

                <div class="row mb-3">
                    <label for="eartag" class="col-sm-2 col-form-label">Ear Tag</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('eartag')) ? 'is-invalid' : ''; ?>" id="eartag" name="eartag" value="<?= old('eartag'); ?>">
                    </div>
                </div>
                <div class=" row mb-3">
                ...
                <div class=" row mb-3">
                    <label for="bobot" class="col-sm-2 col-form-label">Bobot Sapi</label>
                    <div class="col-sm-10">
                ...
                <div class=" row mb-3">
                    <label for="kandang" class="col-sm-2 col-form-label">Dari Kandang</label>
                    <div class="col-sm-10">
                ...
                <div class=" row mb-3">
                    <label for="shifmen" class="col-sm-2 col-form-label">Kedatangan ke</label>
                    <div class="col-sm-10">
